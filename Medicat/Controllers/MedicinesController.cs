...
namespace Medicat.Controllers
{
    public class MedicinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Unit")] Medicine medicine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Unit")] Medicine medicine)
        {
            if (id != medicine.Id)
            {
                return NotFound();
